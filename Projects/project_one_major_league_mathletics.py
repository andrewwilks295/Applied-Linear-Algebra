...
print("-------------------------------------------------------------------------\n")
print("What significant differences do you observe? Why did they change?")
print("Answer: Jorge and Hermie switch places with the second scoring because")
print("        Jorge has more first place votes and 7 is a bigger multiplier than 5.")
print("        However, Instead of truely switching places, Izzy overtakes Hermie")
print("        in the second scoring.\n")
...
print("-------------------------------------------------------------------------\n")
print("Is there a point vector for which Manny Leung does not get last place?")
print("Answer: Yes, if you put the scoring to (1, 1, 1, 1, 1), he finishes in 14th, not 15th.\n")

ranking = []
for i in range(len(x)):
    score = 1*(x[i][0]) + 1*(x[i][1]) + 1*(x[i][2]) + 1*(x[i][3]) + 1*(x[i][4])
    ranking.append([score, i])
